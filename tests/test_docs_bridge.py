"""Tests for epy_mdr.docs_bridge (pure Python, no Qt required)."""
...
def test_epy_docs_available_true():
    ...
    with patch(
        "epy_mdr.docs_bridge.importlib.util.find_spec",
...
def test_list_layouts_returns_real_values():
    ...
    from epy_mdr.docs_bridge import list_layouts
...
def test_list_document_types_returns_real_values():
    ...
    from epy_mdr.docs_bridge import list_document_types
...
def test_list_layouts_raises_when_unavailable():
    ...
    from epy_mdr.docs_bridge import BridgeUnavailableError, list_layouts
...
def test_list_document_types_raises_when_unavailable():
    ...
    from epy_mdr.docs_bridge import (
