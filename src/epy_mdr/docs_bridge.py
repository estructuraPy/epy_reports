"""Bridge module between epy_mdr and the optional epy_docs package.

Independence contract
---------------------
This is the **only** module in epy_mdr that may reference ``epy_docs``.
...
def list_layouts() -> list[str]:
    ...
    if not epy_docs_available():
        raise BridgeUnavailableError(
            "epy_docs is not installed. "
            "Install it with: pip install epy-docs"
        )
